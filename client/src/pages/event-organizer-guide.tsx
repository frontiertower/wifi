...
export default function EventOrganizerGuide() {
  return (
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100" data-testid="heading-event-organizer-guide">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <Link href="/code-of-conduct">
              <Button variant="outline" data-testid="button-view-code-of-conduct">
