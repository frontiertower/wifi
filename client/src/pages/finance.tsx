              ...
              <div className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="terminal-label">
                        INVESTOR RELATIONS & FUNDRAISING EXPERIENCE
                      </FormLabel>
                      <FormControl>
                        <Textarea 
                          className="terminal-textarea min-h-[100px]" 
                          placeholder="Describe fundraising rounds managed, investor base size, and communication strategies..."
                          {...field}
                          value={field.value || ""}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="terminal-label">
                        EXECUTIVE COLLABORATION & BOARD EXPERIENCE
                      </FormLabel>
                      <FormControl>
                        <Textarea 
                          className="terminal-textarea min-h-[100px]" 
                          placeholder="Describe experience working with C-suite, board interactions, and strategic planning..."
                          {...field}
                          value={field.value || ""}
            ...
            <div className="terminal-section">
              ...
              <div className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="terminal-label">WHY FRONTIER TOWER? WHAT DRIVES YOU?</FormLabel>
                      <FormControl>
                        <Textarea 
                          className="terminal-textarea min-h-[150px]" 
                          placeholder="Tell us about your motivation, what excites you about this opportunity, and what you want to build..."
                          {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="terminal-label">HOW DID YOU HEAR ABOUT US?</FormLabel>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          className="terminal-input" 
                          placeholder="https://your-portfolio.com or github.com/..." 
                          {...field}
                          value={field.value || ""}
