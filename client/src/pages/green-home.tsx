...
import { Wifi, Building2, Calendar, DoorOpen, UserPlus, PartyPopper, MessageCircle, Rocket, Home, Briefcase, Shield, Link2, Wrench, Trophy, Laptop, GraduationCap, ClipboardList, FileText } from "lucide-react";
        ...
        <div className="min-h-screen terminal-bg p-4">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="grid gap-4 md:grid-cols-2 mb-8">
              ...
              >
                <div className="flex items-start">
                  <Trophy className="text-terminal-green mr-3 flex-shrink-0 mt-1 w-5 h-5" />
                  <div>
                    <h3 className="font-bold text-terminal-green">META DEVELOPER COMPETITION</h3>
                    <p className="text-terminal-dim text-xs mt-1">Join the competition</p>
                  </div>
                </div>
              </a>
              ...
              >
                <div className="flex items-start">
                  <Laptop className="text-terminal-green mr-3 flex-shrink-0 mt-1 w-5 h-5" />
                  <div>
                    <h3 className="font-bold text-terminal-green">BOOK COWORKING</h3>
                    <p className="text-terminal-dim text-xs mt-1">Reserve a workspace</p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="flex items-start">
                  <GraduationCap className="text-terminal-green mr-3 flex-shrink-0 mt-1 w-5 h-5" />
                  <div>
