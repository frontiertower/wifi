              ...
              >
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-emerald-100 dark:bg-emerald-500/30 rounded-lg flex items-center justify-center mr-3 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-500/40">
                    <MapPin className="text-emerald-600 dark:text-emerald-300" />
                  </div>
                  <div>
                    <div className="font-medium text-gray-800 dark:text-gray-100">SensAI Hacker Map</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Find rooms & spaces</div>
                  </div>
                </div>
              </a>
              ...
              >
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-amber-100 dark:bg-amber-500/30 rounded-lg flex items-center justify-center mr-3 group-hover:bg-amber-200 dark:group-hover:bg-amber-500/40">
                    <Trophy className="text-amber-600 dark:text-amber-300" />
                  </div>
                  <div>
                    <div className="font-medium text-gray-800 dark:text-gray-100">Meta Developer Competition</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Join the competition</div>
                  </div>
                </div>
              </a>
