...
function AppHeader() {
  ...
  const hideRabbitOn = ["/Regen", "/Finance", "/Green", "/Blue", "/admin", "/admin-login", "/events", "/past-events", "/booking", "/tour", "/rent-office", "/event-host-booking", "/apply-to-join", "/chat", "/directory", "/addlisting", "/careers"];
