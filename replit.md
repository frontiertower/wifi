...
*   **Event Segments**: Admin Segments tab uses AI (GPT-4o) to categorize all events by topic into predefined categories: AI, Web3, Longevity, Human Flourishing, Arts, Music, Founders, Fundraising, Parties, Food, Hackathons, Neuroscience, Biotech, Robotics, Fitness, XR/VR, Meditation. Results stored in `segments text[]` column on events table. Segments tab displays color-coded summary tiles with event counts and expandable detail sections per category.